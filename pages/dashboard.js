...
import ChaiFactory from '../artifacts/contracts/Chai.sol/SodaFactory.json'
...
export default function Dashboard() {
    ...
    const [sodasData, setSodasData] = useState([]);
    ...
    useEffect(() => {process
      ...
      const Request = async () => {
        ...
        const getAllSodas = contract.filters.chaiCreated(null, null, Address);
